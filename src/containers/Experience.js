          ...
          description={
            <List>
              <List.Item>
                ...
                Tech support for Foreign Financial Institution (FFI) and retail customers in Asia Pacific market
              </List.Item>
              <List.Item>
                <List.Icon name="caret right" color="orange" />
        ...
        <ExperienceItem
          ...
          description={
            <List>
              ...
              <List.Item>
                <List.Icon name="caret right" color="orange" />
                World wide field trial, live network test for LTE, WCDMA, GPRS and Operator network certification test
              </List.Item>
              <List.Item>
                <List.Icon name="caret right" color="orange" />
        ...
        <ExperienceItem
          ...
          description={
            <List>
              <List.Item>
                <List.Icon name="caret right" color="orange" />
                Worldwide field trial, live network test for LTE, WCDMA, GPRS and operator network certification test
              </List.Item>
              <List.Item>
                <List.Icon name="caret right" color="orange" />
